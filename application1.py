...
def generate_price_range(predicted_price):

    if predicted_price < 1000000:
        result = predicted_price-predicte_price*.15
    else:
        result = predicted_price-predicted_price*.1
    return { 'min_price': round(result, -4), 'max_price'
        :predicted_price}
